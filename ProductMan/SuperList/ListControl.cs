...
namespace BinaryComponents.SuperList
{
	public class ListControl : SectionContainerControl
	{
        ...
        {
            _groupSectionTextSingular = ResourceHelper.Instance.GetString("ListControl.SingleItem", culture);
            _groupSectionTextPlural = ResourceHelper.Instance.GetString("ListControl.MultiItems", culture);
            _listSection.ChangeLanguage(culture);
            _customiseListSection.ChangeLanguage(culture);
        }
