...
namespace BinaryComponents.WinFormsUtility.Dialogs
{
    partial class WizardForm
    {
        ...
        private void InitializeComponent()
        {
					...
					this._nextDelayedAction = new BinaryComponents.WinFormsUtility.Events.DelayedAction( this.components );
        ...
        private BinaryComponents.WinFormsUtility.Events.DelayedAction _nextDelayedAction;
    }
}